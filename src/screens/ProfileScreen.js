...
const ProfileScreen = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const userData = await Auth.currentAuthenticatedUser(); //TODO: Move this check to context to make it general for application
      ...
      // query his posts
      const dbPosts = await DataStore.query(Post, (p) => p.postUserId("eq", userId));
      setPosts(dbPosts);
    };
